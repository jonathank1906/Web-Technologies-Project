<section class="flex flex-col items-start transition duration-150 ease-out hover:bg-gray-500/10">
    ...
    <div class="flex justify-between w-full">
        <div class="flex">
            <div>
                <div
                    class="relative w-16 h-16 m-4 flex flex-shrink-0 items-center justify-center text-2xl bg-white rounded-full shadow-md shadow-black">
        ...
        <button wire:click="openMessages"
            ...
            <x-tabler-message-circle-filled class="w-7 h-7" />
        </button>
    </div>
</section>