<div class="flex h-screen bg-[#f8f8f8] text-gray-800 font-sans">
    ...
    <div class="w-1/3 bg-white border-r border-gray-300 flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto px-4 pt-2 space-y-4">
            @foreach ([
                ...
                <div
                    class="flex items-start gap-3 p-3 bg-gray-100 rounded-lg hover:bg-yellow-100 cursor-pointer transition shadow-sm">
                    <!-- Avatar -->
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-white shadow-sm">
            <div class="flex items-center gap-3">
                <div class="relative w-10 h-10 flex items-center justify-center text-xl bg-white rounded-full shadow">
                    <span>🧑</span>
                    <img src="/flags/lv.png" alt="LV" class="absolute bottom-0 right-0 w-4 h-4 rounded-full border border-white" />
                </div>
                <div>
            ...
            <div class="flex items-center gap-3">
                <button title="Attach">
                    <i class="fas fa-paperclip text-gray-600 hover:text-blue-500"></i>
                </button>
                <button title="More">
                    <i class="fas fa-ellipsis-v text-gray-600 hover:text-blue-500"></i>
                </button>
            </div>
        </div>

        <!-- Chat Messages -->
        <div class="flex-1 overflow-y-auto px-6 py-4 space-y-3 bg-[#f9f9f9]">
