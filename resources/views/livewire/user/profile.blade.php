        ...
        <div class="p-6">
            <div class="flex items-center space-x-6">
                ...
                <aside class="flex space-x-6 text-center" aria-label="User statistics">
                    <div>
                        <p class="text-2xl font-bold text-base-content">{{ $user->posts_count }}</p>
                        <p class="text-sm text-base-content/50">Posts</p>
                    </div>
                    <div>
                        <p class="text-2xl font-bold text-base-content">{{ $user->followers_count }}</p>
                        <p class="text-sm text-base-content/50">Followers</p>
                    </div>
                    <div>
                        <p class="text-2xl font-bold text-base-content">{{ $user->following_count }}</p>
